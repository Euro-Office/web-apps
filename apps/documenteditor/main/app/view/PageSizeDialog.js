        ...
        render: function() {
            ...
            this.cmbPreset = new Common.UI.ComboBox({
                ...
                data: [
                    ...
                    { value: 100, displayValue: 'Trade Paperback (small)', size: [139.7, 215.9]},
                    { value: 101, displayValue: 'Trade Paperback (Large)', size: [152.4, 228.6]},
                    { value: 102, displayValue: '6.14x9.21', size: [156, 233.9]},
                    { value: 103, displayValue: '7x10', size: [177.8, 254]},
                    { value: 104, displayValue: '8.25x11', size: [209.5, 279.4]},
                    { value: 105, displayValue: 'Mass-Market Paperback', size: [107.95, 174.5]},
                    { value: 106, displayValue: 'A Format', size: [110, 178]},
                    { value: 107, displayValue: 'Penguin', size: [111, 181]},
                    { value: 108, displayValue: 'B Format', size: [138, 216]},
