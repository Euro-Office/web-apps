...
define([
    'core',
    'documenteditor/main/app/view/FormsTabSec'
], function () {
    'use strict';

    DE.Controllers.FormsTabSec = Backbone.Controller.extend({
        models : [],
        collections : [
        ],
        views : [
        ...
        setApi: function (api) {
            ...
            Common.NotificationCenter.on({
                'api:disconnect': this.onCoAuthoringDisconnect.bind(this),
        ...
        setConfig: function(config) {
            ...
            this.view = this.createView('FormsTabSec', {
            ...
            this.appConfig.isEdit &&
                this.appConfig.canFeatureContentControl &&
                this.appConfig.isFormCreator &&
                !this.appConfig.isOForm && this.api.asc_registerCallback('asc_onOFormChangeFinal', _.bind(this.onOFormChangeFinal, this))
        },
